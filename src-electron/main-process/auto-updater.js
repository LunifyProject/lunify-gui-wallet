...
async function showUpdateDialog(mainWindow) {
  ...
  const options = {
    ...
    title: "Lunify Electron Wallet update available",
    message: "There is a new version of Lunify Electron Wallet available.",
...
async function showCannotUpdateDialog(mainWindow) {
  const options = {
    ...
    title: "Cannot update",
    message:
      "Lunify Electron Wallet failed to update but there is a new version available. Please go to https://lunify.xyz/ and install the new version manually."
  };
