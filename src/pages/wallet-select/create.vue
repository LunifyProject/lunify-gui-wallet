<template>
  <q-page class="create-wallet">
    <div class="fields q-mx-md q-mt-md">
      <LunifyField :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
        <q-input
          v-model="wallet.name"
          :dark="theme == 'dark'"
      ...
      <LunifyField :label="$t('fieldLabels.seedLanguage')">
        <q-select v-model="wallet.language" :options="languageOptions" :dark="theme == 'dark'" borderless dense />
      </LunifyField>

      <LunifyField :label="$t('fieldLabels.password')" optional>
        <q-input
