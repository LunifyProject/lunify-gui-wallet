<template>
  <q-page>
    <div class="q-mx-md">
      <LunifyField class="q-mt-md" :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
        <q-input
          v-model="wallet.name"
      ...
      <LunifyField class="q-mt-md" :label="$t('fieldLabels.mnemonicSeed')" :error="$v.wallet.seed.$error">
        <q-input
          v-model="wallet.seed"
          class="full-width text-area-lunify"
      ...
      <div class="row items-end q-mt-md">
        <div class="col-md-9 col-sm-8">
          <LunifyField v-if="wallet.refresh_type == 'date'" :label="$t('fieldLabels.restoreFromDate')">
      ...
      <LunifyField class="q-mt-md" :label="$t('fieldLabels.password')">
        <q-input
      ...
      <LunifyField class="q-mt-md" :label="$t('fieldLabels.confirmPassword')">
        <q-input
