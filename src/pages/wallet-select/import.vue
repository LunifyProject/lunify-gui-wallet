<template>
  <q-page>
    <div class="q-mx-md import-wallet">
      <LunifyField :label="$t('fieldLabels.newWalletName')" :error="$v.wallet.name.$error">
        <q-input
          v-model="wallet.name"
      ...
      <LunifyField :label="$t('fieldLabels.walletFile')" disable-hover :error="$v.wallet.path.$error">
        <q-input
          v-model="wallet.path"
      ...
      <LunifyField :label="$t('fieldLabels.password')">
        <q-input
      ...
      <LunifyField :label="$t('fieldLabels.confirmPassword')">
        <q-input
