    ...
    <template v-else>
      <div class="q-pa-md">
        ...
        <div class="col q-mt-sm">
          <LunifyField :label="$t('fieldLabels.address')" :error="$v.newTx.address.$error">
            <q-input
        ...
        <!-- Payment ID -->
        <div class="col q-mt-sm">
          <LunifyField :label="$t('fieldLabels.paymentId')" :error="$v.newTx.payment_id.$error" optional>
            <q-input
        ...
        <!-- Notes -->
        <div class="col q-mt-sm">
          <LunifyField :label="$t('fieldLabels.notes')" optional>
            <q-input
              v-model="newTx.note"
        ...
        <div v-if="newTx.address_book.save">
          <LunifyField :label="$t('fieldLabels.name')" optional>
            <q-input
          ...
          <LunifyField class="q-mt-sm" :label="$t('fieldLabels.notes')" optional>
            <q-input
