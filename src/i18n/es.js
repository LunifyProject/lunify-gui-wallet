export default {
  ...
  menuItems: {
    ...
    exit: "Cerrar la interfaz del monedero Lunify",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "lunifyd no encontrado, utilizando nodo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    lunifyBalance: "Saldo",
    lunifyUnlockedBalance: "Saldo libre",
    lunifyUnlockedShort: "Libre",
    ...
    serviceNodeRegistrationDescription:
      'Introduzca la orden {registerCommand} generada por el servicio (lunifyd) que se está intentado registrar como Nodo de Servicio usando la instrucción "{prepareCommand}"',
    spendKey: "Clave de gasto",
