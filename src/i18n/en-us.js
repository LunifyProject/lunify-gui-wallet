export default {
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "Lunifyd not found, using remote node"
    }
  },
  placeholders: {
    ...
    lnsName: "The name to purchase via Lunify Name Service",
    ...
    sessionId: "The Session ID to link to Lunify Name Service",
  ...
  strings: {
    ...
    lunifyBalance: "Balance",
    lunifyUnlockedBalance: "Unlocked balance",
    lunifyUnlockedShort: "Unlocked",
    me: "Me",
