export default {
  ...
  menuItems: {
    ...
    exit: "Saír da Carteira GUI Lunify",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "lunifyd não encontrado, utilizando nódulo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    lunifyBalance: "Saldo",
    lunifyUnlockedBalance: "Saldo desbloqueado",
    lunifyUnlockedShort: "Desbloqueado",
