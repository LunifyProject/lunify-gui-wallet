export default {
  ...
  menuItems: {
    ...
    exit: "Quitter le portefeuille Lunify GUI",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "lunifyd introuvable, utilisation du nœud distant"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    lunifyBalance: "Solde",
    lunifyUnlockedBalance: "Solde débloqué",
    lunifyUnlockedShort: "Débloqué",
