export default {
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "Не найден файл lunifyd, используется удаленная нода"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    lunifyBalance: "Баланс",
    lunifyUnlockedBalance: "Разблокированый баланс",
    lunifyUnlockedShort: "Разблокировано",
