    ...
    <q-layout>
      ...
      <q-page-container>
        <div class="layout-padding">
          ...
          <div class="info row justify-between">
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span><FormatLunify :amount="node.staking_requirement" raw-value/></span>
                </div>
              </div>
            </div>
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span><FormatLunify :amount="node.total_contributed" raw-value/></span>
                </div>
              </div>
            </div>
            <div class="infoBox">
          ...
          <q-list no-border :dark="theme == 'dark'" class="lunify-list">
            <q-item-label class="contributors-title">{{ $t("strings.serviceNodeDetails.contributors") }}:</q-item-label>
            <q-item v-for="contributor in contributors" :key="contributor.address" class="lunify-list-item">
              <q-item-label>
                ...
                <q-item-label class="non-selectable" caption>
                  ...
                  <FormatLunify :amount="contributor.amount" raw-value />
                </q-item-label>
              </q-item-label>
              <q-menu context-menu>
