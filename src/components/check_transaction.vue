<template>
  <div class="check-transaction">
    <div class="q-pa-md">
      ...
      <div>
        <LunifyField :label="$t('fieldLabels.transactionId')" :error="$v.txid.$error">
          <q-input
            v-model.trim="txid"
            :dark="theme == 'dark'"
        ...
        <LunifyField class="q-mt-md" :label="$t('fieldLabels.address')" :error="$v.address.$error" optional>
          <q-input
        ...
        <LunifyField class="q-mt-md" :label="$t('fieldLabels.message')" optional>
          <q-input
        ...
        <LunifyField class="q-mt-md" :label="$t('fieldLabels.signature')" :error="$v.signature.$error">
          <q-input
      ...
      <div v-if="status.state.txid">
        ...
        <div v-if="status.state.received != null" class="q-mb-sm">
          ...
          <div>
            <FormatLunify :amount="status.state.received" raw-value />
          </div>
        </div>
...
import FormatLunify from "components/format_lunify";
