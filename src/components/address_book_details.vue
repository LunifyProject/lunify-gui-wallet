    ...
    <q-layout v-if="mode == 'edit' || mode == 'new'">
      ...
      <q-page-container>
        <div class="address-book-modal q-mx-md">
          <LunifyField :label="$t('fieldLabels.address')" :error="$v.newEntry.address.$error">
            <q-input
          ...
          <LunifyField :label="$t('fieldLabels.name')">
            <q-input v-model.trim="newEntry.name" :dark="theme == 'dark'" borderless dense />
          </LunifyField>
          <LunifyField :label="$t('fieldLabels.paymentId')" :error="$v.newEntry.payment_id.$error" optional>
            <q-input
