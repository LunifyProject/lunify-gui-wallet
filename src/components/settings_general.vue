<template>
  <div class="settings-general">
    ...
    <template v-if="config_daemon.type != 'remote'">
      <div class="row pl-sm">
        <LunifyField class="col-8" :label="$t('fieldLabels.localDaemonIP')" disable>
          <q-input
        ...
        <LunifyField class="col-4" :label="$t('fieldLabels.localDaemonPort') + '(RPC)'">
          <q-input
    ...
    <template v-if="config_daemon.type != 'local'">
      <div class="row q-mt-md pl-sm">
        <LunifyField class="col-8" :label="$t('fieldLabels.remoteNodeHost')">
          <q-input
        ...
        <LunifyField class="col-4" :label="$t('fieldLabels.remoteNodePort')">
          <q-input
    ...
    <div class="col q-mt-md pt-sm">
      <LunifyField :label="$t('fieldLabels.dataStoragePath')" disable-hover>
      ...
      <LunifyField :label="$t('fieldLabels.walletStoragePath')" disable-hover>
    ...
    >
      <div class="row pl-sm q-mt-sm">
        <LunifyField class="col-6" :label="$t('fieldLabels.daemonLogLevel')" :disable="is_remote">
          <q-input
        ...
        <LunifyField class="col-6" :label="$t('fieldLabels.walletLogLevel')">
          <q-input
      ...
      <div class="row pl-sm q-mt-md">
        ...
        <LunifyField class="col-3" :label="$t('fieldLabels.maxIncomingPeers')" :disable="is_remote">
          <q-input
        ...
        <LunifyField class="col-3" :label="$t('fieldLabels.maxOutgoingPeers')" :disable="is_remote">
          <q-input
        ...
        <LunifyField class="col-3" :label="$t('fieldLabels.limitUploadRate')" :disable="is_remote">
          <q-input
        ...
        <LunifyField class="col-3" :label="$t('fieldLabels.limitDownloadRate')" :disable="is_remote">
          <q-input
      ...
      <div class="row pl-sm q-mt-md">
        <LunifyField class="col-3" :label="$t('fieldLabels.daemonP2pPort')" :disable="is_remote">
          <q-input
        ...
        <LunifyField class="col-3" :label="$t('fieldLabels.daemonZMQPort')" :disable="is_remote">
          <q-input
        ...
        <LunifyField class="col-3" :label="$t('fieldLabels.internalWalletPort')">
          <q-input
        ...
        <LunifyField class="col-3" :label="$t('fieldLabels.walletRPCPort')" :disable="is_remote">
          <q-input
...
import LunifyField from "components/lunify_field";
export default {
