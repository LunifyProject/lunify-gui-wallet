<template>
  <div class="service-node-staking">
    <div class="q-px-md q-pt-md">
      <LunifyField :label="$t('fieldLabels.serviceNodeKey')" :error="$v.service_node.key.$error">
        <q-input
      ...
      <LunifyField :label="$t('fieldLabels.amount')" class="q-mt-md" :error="$v.service_node.amount.$error">
        <q-input
        ...
        <q-btn
          ...
          @click="service_node.amount = unlocked_balance / 1e8"
        >
          {{ $t("buttons.all") }}
        </q-btn>
      </LunifyField>
