    ...
    <q-btn icon-right="more_vert" :label="$t('buttons.settings')" size="md" flat>
      <q-menu anchor="bottom right" self="top right">
        <q-list separator class="menu-list">
          <q-item v-close-popup clickable @click.native="getPrivateKeys()">
      ...
      <div class="modal key-image-modal">
        ...
        <div class="q-ma-lg">
          ...
          <template v-if="modals.key_image.type == 'Export'">
            <LunifyField class="q-mt-lg" :label="$t('fieldLabels.keyImages.exportDirectory')" disable-hover>
          ...
          <template v-if="modals.key_image.type == 'Import'">
            <LunifyField class="q-mt-lg" :label="$t('fieldLabels.keyImages.importFile')" disable-hover>
