<template>
  <div class="lns-input-form">
    ...
    <div class="col q-mt-sm">
      <LunifyField :label="$t('fieldLabels.name')" :disable="disableName" :error="$v.record.name.$error">
        <q-input
    ...
    <!-- Value (Session ID, Wallet Address or .lunify address) -->
    <div class="col q-mt-sm">
      <LunifyField class="q-mt-md" :label="value_field_label" :error="$v.record.value.$error">
        <q-input
    ...
    <!-- Owner -->
    <div class="col q-mt-sm">
      <LunifyField class="q-mt-md" :label="$t('fieldLabels.owner')" :error="$v.record.owner.$error" optional>
        <q-input
    ...
    <!-- Backup owner -->
    <div class="col q-mt-sm">
      <LunifyField class="q-mt-md" :label="$t('fieldLabels.backupOwner')" :error="$v.record.backup_owner.$error" optional>
        <q-input
