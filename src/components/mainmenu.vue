  ...
  <div>
    ...
    <q-dialog ref="aboutModal" minimized>
      <div class="about-modal">
        <img class="q-mb-md" src="logo_with_text.svg" height="42" />

        <p class="q-my-sm">Wallet Version: v{{ version }}</p>
        <p class="q-my-sm">Deaemon Version: v{{ daemonVersion }}</p>
        <br>
        <p class="q-my-sm">Copyright &copy; 2025, Lunify Project</p>
        <p class="q-my-sm">Copyright &copy; 2018-2019, Loki Network</p>
        <p class="q-my-sm">Copyright &copy; 2018, Ryo Currency Project</p>
        <p class="q-my-sm">All rights reserved.</p>

        <div class="q-mt-md q-mb-lg external-links">
          <p>
            <a href="#" @click="openExternal('https://lunify.xyz/')">https://lunify.xyz/</a>
          </p>
          <p>
            <a href="#" @click="openExternal('https://discord.gg/NqHb64D9mu')">Discord</a>
            -
            <a href="#" @click="openExternal('https://x.com/LunifyProject')">X</a>
            -
            <a href="#" @click="openExternal('https://github.com/LunifyProject/lunify-gui-wallet')">Github</a>
          </p>
        </div>
